...
import { newAppointmentMock, updateAppointmentMock, nearbyServices as mockNearbyServices, appointments as mockAppointments } from '@/mock/client/mock-data';
    ...
    return (
        <div className="w-full h-full pt-24">
            ...
            <textarea
                ...
                value={JSON.stringify(nearbyServices, null, 4)}
                readOnly
            />
